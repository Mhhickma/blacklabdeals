"""
Keepa Deals Endpoint + Amazon Creators API Ã¢ÂÂ Deal Scraper
----------------------------------------------------------
...
def get_keepa_deals(api_key, cached_asins):
    ...
    for item in all_deals:
        ...
        # Min price $10 Ã¢ÂÂ current is a list, index varies by price type
...
def main():
    print("=" * 55)
    print("  Keepa Deals + Amazon Creators API Ã¢ÂÂ DealDrop")
    print("=" * 55)

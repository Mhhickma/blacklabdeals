...
(function(){
  ...
  function addCompliance(){
    ...
    sc.src='/site-common.js?v=14';
    sc.defer=true;
    document.body.appendChild(sc);
  }
  function headerHtml(){
    var homeHash=isHome()?'#deals-section':'/#deals-section';
    var alertHash=isHome()?'#alerts-box':'/#alerts-box';
    return '<header class="bld-header-shell"><div class="bld-header-main"><a href="/" class="bld-brand"><img class="bld-brand-logo" src="/logo-128.jpg" alt="Black Lab Deals logo"><div><div class="bld-brand-title">Black Lab <span>Deals</span></div><div class="bld-brand-tagline">Fresh Amazon product picks updated daily</div></div></a><nav class="bld-nav"><a href="/categories/">Categories</a><a href="'+homeHash+'">All Product Picks</a><a href="/top-100-amazon-deals-today/">Top 100</a><a href="/best-amazon-tool-deals/">Tools</a><a href="/best-amazon-home-kitchen-deals/">Home &amp; Kitchen</a><a class="bld-alert-btn" href="'+alertHash+'">Get Alerts</a></nav></div><div class="bld-search-row"><form class="bld-search" action="/search.html" method="get"><input type="search" name="q" placeholder="Search product picks"><button type="submit">Search</button></form></div></header>';
  }
  function mount(){
    addStyles();
    ...
    addCompliance();
    setTimeout(function(){document.body.classList.add('bld-feed-ready')},2500);
    setTimeout(function(){document.body.classList.add('bld-feed-ready')},6000);
  }
